...
export const config = {
  light: vars({
    ...
    /* Background */
    "--color-background-0": "#f5f3ff",
    "--color-background-50": "#ede9fe",
    "--color-background-100": "#ddd6fe",
    "--color-background-200": "#c4b5fd",
    "--color-background-300": "#a78bfa",
    "--color-background-400": "#8b5cf6",
    "--color-background-500": "#7c3aed",
    "--color-background-600": "#6d28d9",
    "--color-background-700": "#5b21b6",
    "--color-background-800": "#4c1d95",
    "--color-background-900": "#2e1065",
  ...
  dark: vars({
    ...
    /* Background */
    "--color-background-0": "#052e16",
    "--color-background-50": "#f0fdf4",
    "--color-background-100": "#dcfce7",
    "--color-background-200": "#bbf7d0",
    "--color-background-300": "#86efac",
    "--color-background-400": "#4ade80",
    "--color-background-500": "#22c55e",
    "--color-background-600": "#16a34a",
    "--color-background-700": "#15803d",
    "--color-background-800": "#166534",
    "--color-background-900": "#14532d",
    "--color-background-950": "#052e16",
